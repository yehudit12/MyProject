        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionIdId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Claims_Permissions_PermissionIdId",
                        column: x => x.PermissionIdId,
                        principalTable: "Permissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Claims_Roles_RoleIdId",
                        column: x => x.RoleIdId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_PermissionIdId",
                table: "Claims",
                column: "PermissionIdId");

            migrationBuilder.CreateIndex(
                name: "IX_Claims_RoleIdId",
                table: "Claims",
                column: "RoleIdId");
        }
